...
class RBUSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class RBUExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(RBUDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new RBUStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static RBUDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static RBUDateTimeConverter dateTimeConverter = new RBUStandardDateTimeConverter();

    public RBUExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public RBUExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new RBUMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=RBUHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,RBUExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=RBUHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
