...
public class RBUKPSPublicSoap
{
    ...
    public RBUKPSPublicSoap(){}

    public RBUKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public RBUKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        RBUExtendedSoapSerializationEnvelope envelope= new RBUExtendedSoapSerializationEnvelope(RBUExtendedSoapSerializationEnvelope.VER11);
